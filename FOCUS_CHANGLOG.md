...
### 版本信息
- 基于上游 `BiliPai v7.1.1` 维护 Focus 发布线，当前推荐对外版本为 `7.1.1-focus.2`，为保证已发布 Focus 版本可持续升级，`versionCode` 继续递增到 `136`。
- 本次为“合并上游 `7.1.1` 语言与沉浸式修复 + 首页关注过滤刷新重构 + 顶栏安全区回到上游基线”的稳定性更新。
...
### 构建与发布
- Focus 版本号提升到 `v7.1.1-focus.2`，APK 命名切换为 `BliPai-Focus-*-7.1.1-focus.2*.apk`。
- README / README_EN / CHANGELOG / Focus Changelog / Release Notes 已同步切到 `7.1.1-focus.2` 发布线，并补充本轮首页关注过滤恶性空态与分页覆盖修复说明。
