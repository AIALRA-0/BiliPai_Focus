...
### 版本信息
- 基于上游 `BiliPai v7.1.0` 维护 Focus 发布线，当前推荐对外版本为 `7.1.0-focus.10`，`versionCode` 为 `133`。
- 本次为“首页关注按 8 个一批补页 + `focus.10` 构建发布”的维护更新。
...
- 首页“关注”现在进一步收口为固定 `8` 个可见视频一批的展示节奏；无论是首批展示、后续补齐还是继续加载，都会先凑够下一批再统一更新，避免重新退化成一条一条往外冒。
