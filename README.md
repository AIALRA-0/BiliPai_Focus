...
<p align="center">
  <sub>最后更新：2026-04-08 · 上游基线 v7.5.1 · 当前 Focus 发布 v7.5.1-focus.3</sub>
</p>
...
| 类别 | 入口 |
| --- | --- |
| 开始使用 | [官方 Releases](https://github.com/jay3-yy/BiliPai/releases) · Focus Releases（当前仓库 Releases 页面） · [Focus Release Notes](docs/releases/focus-7.5.1-focus.3.md) · [更新日志](CHANGELOG.md) · [Focus 变更日志](FOCUS_CHANGLOG.md) |
...
| Focus 定制版 | 想保留原生能力，同时获得更克制的默认入口、关注过滤和专注模式开关 | 当前 Focus 仓库 · 当前仓库 Releases 页面 · [Release Notes](docs/releases/focus-7.5.1-focus.3.md) · [Focus 变更日志](FOCUS_CHANGLOG.md) |

### 当前 Focus 发布

| 项目 | 内容 |
| --- | --- |
| Focus 版本 | `7.5.1-focus.3` |
| 上游基线 | `7.5.1` |
| 发布标签 | `v7.5.1-focus.3` |
| Release Notes | [docs/releases/focus-7.5.1-focus.3.md](docs/releases/focus-7.5.1-focus.3.md) |
| 主要收口 | 继续停留在官方 `7.5.1` 版本线，本次主要验证 Focus 应用内更新链路与正式发版流程；业务代码保持 `.2` 的播放器 Home 返回主页修复不变 |
| 对外 APK | `BliPai-Focus-release-7.5.1-focus.3.apk` |
...
| 新增 | `docs/releases/focus-7.5.1-focus.3.md` | Focus `v7.5.1-focus.3` 中文发布说明 |
| 新增 | `docs/releases/focus-7.5.1-focus.3-en.md` | Focus `v7.5.1-focus.3` 英文发布说明 |
...
<p align="left">
  ...
  <a href="docs/releases/focus-7.5.1-focus.3.md">
...
### 最近更新 (v7.5.1 / v7.5.1-focus.3 · 2026-04-08)

- 🔄 **继续停留在官方 `7.5.1` 版本线**：官方 `7.5.1` tag 与 `7.5.0` 仍指向同一源码提交，因此这次 `.3` 不引入新的 upstream 代码，主要用于验证 Focus 的应用内更新检测与发布链路。
- 🏠 **播放器 Home 修复继续保留**：业务代码维持 `.2` 已完成的“房子按钮真正回首页”修复不变。
