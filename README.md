...
<p align="center">
  <sub>最后更新：2026-03-24 · 上游基线 v7.1.2 · 当前 Focus 发布 v7.1.2-focus.6</sub>
</p>
...
| 类别 | 入口 |
| --- | --- |
| 开始使用 | [官方 Releases](https://github.com/jay3-yy/BiliPai/releases) · [Focus Releases](https://github.com/AIALRA-0/BiliPai_Focus/releases) · [Focus Release Notes](docs/releases/focus-7.1.2-focus.6.md) · [更新日志](CHANGELOG.md) · [Focus 变更日志](FOCUS_CHANGLOG.md) |
...
| Focus 定制版 | 想保留原生能力，同时获得更克制的默认入口、关注过滤和专注模式开关 | [仓库](https://github.com/AIALRA-0/BiliPai_Focus) · [Releases](https://github.com/AIALRA-0/BiliPai_Focus/releases) · [Release Notes](docs/releases/focus-7.1.2-focus.6.md) · [Focus 变更日志](FOCUS_CHANGLOG.md) |

### 当前 Focus 发布

| 项目 | 内容 |
| --- | --- |
| Focus 版本 | `7.1.2-focus.6` |
| 上游基线 | `7.1.2` |
| 发布标签 | `v7.1.2-focus.6` |
| Release Notes | [docs/releases/focus-7.1.2-focus.6.md](docs/releases/focus-7.1.2-focus.6.md) |
| 主要收口 | 首页“关注”下拉刷新改成整页重排；继续下滑时按 `16` 条一组展示并优先复用已抓缓存；保留现有并发快速抓取路径，兼顾刷新速度与低配设备压力 |
| 对外 APK | `BliPai-Focus-release-7.1.2-focus.6.apk` |
...
| 新增 | `docs/releases/focus-7.1.2-focus.6.md` | Focus `v7.1.2-focus.6` 中文发布说明 |
| 新增 | `docs/releases/focus-7.1.2-focus.6-en.md` | Focus `v7.1.2-focus.6` 英文发布说明 |
