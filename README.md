...
| 类别 | 入口 |
| --- | --- |
| 开始使用 | [官方 Releases](https://github.com/jay3-yy/BiliPai/releases) · Focus Releases（当前仓库 Releases 页面） · [Focus Release Notes](docs/releases/focus-7.5.0-focus.1.md) · [更新日志](CHANGELOG.md) · [Focus 变更日志](FOCUS_CHANGLOG.md) |
...
| Focus 定制版 | 想保留原生能力，同时获得更克制的默认入口、关注过滤和专注模式开关 | 当前 Focus 仓库 · 当前仓库 Releases 页面 · [Release Notes](docs/releases/focus-7.5.0-focus.1.md) · [Focus 变更日志](FOCUS_CHANGLOG.md) |
...
<p align="left">
  ...
  <a href="docs/releases/focus-7.5.0-focus.1.md">
