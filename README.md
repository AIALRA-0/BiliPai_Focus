...
<p align="center">
  <sub>最后更新：2026-03-23 · 上游基线 v7.1.0 · 当前 Focus 发布 v7.1.0-focus.10</sub>
</p>

<p align="center">
  <img src="https://img.shields.io/badge/Focus-7.1.0--focus.10-fb7299?style=flat-square" alt="Focus Version">
...
| 类别 | 入口 |
| --- | --- |
| 开始使用 | [官方 Releases](https://github.com/jay3-yy/BiliPai/releases) · [Focus Releases](https://github.com/AIALRA-0/BiliPai_Focus/releases) · [Focus Release Notes](docs/releases/focus-7.1.0-focus.10.md) · [更新日志](CHANGELOG.md) · [Focus 变更日志](FOCUS_CHANGLOG.md) |
...
| Focus 定制版 | 想保留原生能力，同时获得更克制的默认入口、关注过滤和专注模式开关 | [仓库](https://github.com/AIALRA-0/BiliPai_Focus) · [Releases](https://github.com/AIALRA-0/BiliPai_Focus/releases) · [Release Notes](docs/releases/focus-7.1.0-focus.10.md) · [Focus 变更日志](FOCUS_CHANGLOG.md) |

### 当前 Focus 发布

| 项目 | 内容 |
| --- | --- |
| Focus 版本 | `7.1.0-focus.10` |
| 上游基线 | `7.1.0` |
| 发布标签 | `v7.1.0-focus.10` |
| Release Notes | [docs/releases/focus-7.1.0-focus.10.md](docs/releases/focus-7.1.0-focus.10.md) |
| 主要收口 | 首页“关注”改成按 8 个一批补页；初次显示、后续补齐和继续加载都按批次推进，不再退化成一条一条往外冒 |
| APK 命名 | `BliPai-Focus-debug-7.1.0-focus.10-debug.apk` · `BliPai-Focus-release-7.1.0-focus.10.apk` |
...
- 动态页与首页“关注”在 Focus 过滤后会主动继续补页，尽量先把可见内容补到更稳定的数量级后再展示，减少刷新后条目数量反复跳变。
...
| 新增 | `docs/releases/focus-7.1.0-focus.10.md` | Focus `focus.10` 中文发布说明 |
| 新增 | `docs/releases/focus-7.1.0-focus.10-en.md` | Focus `focus.10` 英文发布说明 |
