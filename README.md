...
<p align="center">
  <sub>最后更新：2026-03-24 · 上游基线 v7.1.3 · 当前 Focus 发布 v7.1.3-focus.1</sub>
</p>
...
| 类别 | 入口 |
| --- | --- |
| 开始使用 | [官方 Releases](https://github.com/jay3-yy/BiliPai/releases) · [Focus Releases](https://github.com/AIALRA-0/BiliPai_Focus/releases) · [Focus Release Notes](docs/releases/focus-7.1.3-focus.1.md) · [更新日志](CHANGELOG.md) · [Focus 变更日志](FOCUS_CHANGLOG.md) |
...
| Focus 定制版 | 想保留原生能力，同时获得更克制的默认入口、关注过滤和专注模式开关 | [仓库](https://github.com/AIALRA-0/BiliPai_Focus) · [Releases](https://github.com/AIALRA-0/BiliPai_Focus/releases) · [Release Notes](docs/releases/focus-7.1.3-focus.1.md) · [Focus 变更日志](FOCUS_CHANGLOG.md) |

### 当前 Focus 发布

| 项目 | 内容 |
| --- | --- |
| Focus 版本 | `7.1.3-focus.1` |
| 上游基线 | `7.1.3` |
| 发布标签 | `v7.1.3-focus.1` |
| Release Notes | [docs/releases/focus-7.1.3-focus.1.md](docs/releases/focus-7.1.3-focus.1.md) |
| 主要收口 | 同步上游 `7.1.3`；首页“关注”首次进入和刷新后都严格只展示首批 `16` 条；刷新完成后统一回顶，并锁住刷新后的自动补批直到回顶处理完成 |
| 对外 APK | `BliPai-Focus-release-7.1.3-focus.1.apk` |
...
| 新增 | `docs/releases/focus-7.1.3-focus.1.md` | Focus `v7.1.3-focus.1` 中文发布说明 |
| 新增 | `docs/releases/focus-7.1.3-focus.1-en.md` | Focus `v7.1.3-focus.1` 英文发布说明 |
