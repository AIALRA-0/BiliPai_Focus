...
<p align="center">
  <sub>最后更新：2026-04-08 · 上游基线 v7.5.1 · 当前 Focus 发布 v7.5.1-focus.2</sub>
</p>
...
| 类别 | 入口 |
| --- | --- |
| 开始使用 | [官方 Releases](https://github.com/jay3-yy/BiliPai/releases) · Focus Releases（当前仓库 Releases 页面） · [Focus Release Notes](docs/releases/focus-7.5.1-focus.2.md) · [更新日志](CHANGELOG.md) · [Focus 变更日志](FOCUS_CHANGLOG.md) |
...
| Focus 定制版 | 想保留原生能力，同时获得更克制的默认入口、关注过滤和专注模式开关 | 当前 Focus 仓库 · 当前仓库 Releases 页面 · [Release Notes](docs/releases/focus-7.5.1-focus.2.md) · [Focus 变更日志](FOCUS_CHANGLOG.md) |

### 当前 Focus 发布

| 项目 | 内容 |
| --- | --- |
| Focus 版本 | `7.5.1-focus.2` |
| 上游基线 | `7.5.1` |
| 发布标签 | `v7.5.1-focus.2` |
| Release Notes | [docs/releases/focus-7.5.1-focus.2.md](docs/releases/focus-7.5.1-focus.2.md) |
| 主要收口 | 继续跟进官方 `7.5.1` 版本线，并把播放器左上角 Home 按钮改成真正强制回首页，不再只退回当前页或上一条视频，同时保留 Focus 的共存包名、Focus-only 更新源、FOLLOW 定制和竖屏长宽比恢复补丁 |
| 对外 APK | `BliPai-Focus-release-7.5.1-focus.2.apk` |
...
| 新增 | `docs/releases/focus-7.5.1-focus.2.md` | Focus `v7.5.1-focus.2` 中文发布说明 |
| 新增 | `docs/releases/focus-7.5.1-focus.2-en.md` | Focus `v7.5.1-focus.2` 英文发布说明 |
...
<p align="left">
  ...
  <a href="docs/releases/focus-7.5.1-focus.2.md">
...
### 最近更新 (v7.5.1 / v7.5.1-focus.2 · 2026-04-08)

- 🔄 **继续跟进官方 `7.5.1` 版本线**：官方 `7.5.1` tag 与 `7.5.0` 仍指向同一源码提交，因此这次是同一版本线上的补丁发布，重点放在本地 Home 导航修复。
- 🏠 **播放器 Home 真正回首页**：左上角房子按钮现在会强制回首页根页面，不再只是回当前页、上一条视频，竖屏全屏下也不会再先退回详情页。
