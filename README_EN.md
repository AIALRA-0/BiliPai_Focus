...
<p align="center">
    <sub>Last updated: 2026-09-23 · Focus sync baseline: 9.1.1-focus.5 (versionCode 388), upstream BiliPai 0.2.3-alpha.2</sub>
  </p>
...
### Focus sync baseline (v9.1.1-focus.5 · versionCode 388)

- Based on upstream `0.2.3-alpha.2`, including the current architecture, build system, plugin SDK, dynamic plugin downloads, and release metadata support.
- Keeps the Focus `9.x` version epoch and advances the Focus suffix so older clients comparing version names detect `9.1.1-focus.5` after `9.1.1-focus.4`; Android `versionCode` advances monotonically to `388`.
