...
<p align="center">
  <sub>Last updated: 2026-03-23 · Upstream base v7.1.0 · Current Focus release v7.1.0-focus.9</sub>
</p>
...
| Category | Entry |
| --- | --- |
| Get Started | [Official Releases](https://github.com/jay3-yy/BiliPai/releases) · [Focus Releases](https://github.com/AIALRA-0/BiliPai_Focus/releases) · [Focus Release Notes](docs/releases/focus-7.1.0-focus.9-en.md) · [Changelog](CHANGELOG.md) · [Focus Changelog](FOCUS_CHANGLOG.md) |
...
| Upstream base | `7.1.0` |
| Release tag | `v7.1.0-focus.9` |
| Release notes | [docs/releases/focus-7.1.0-focus.9-en.md](docs/releases/focus-7.1.0-focus.9-en.md) |
| Main refinements | refreshes Home Follow with a faster first paint and then keeps filling in the background, reducing long waits before the first batch appears |
| APK names | `BliPai-Focus-debug-7.1.0-focus.9-debug.apk` · `BliPai-Focus-release-7.1.0-focus.9.apk` |
...
| Added | `docs/releases/focus-7.1.0-focus.9.md` | Chinese release notes for `focus.9` |
| Added | `docs/releases/focus-7.1.0-focus.9-en.md` | English release notes for `focus.9` |
