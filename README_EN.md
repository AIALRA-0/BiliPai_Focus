...
<p align="center">
  <sub>Last updated: 2026-03-24 · Upstream base v7.1.4 · Current Focus release v7.1.4-focus.4</sub>
</p>
...
| Category | Entry |
| --- | --- |
| Get Started | [Official Releases](https://github.com/jay3-yy/BiliPai/releases) · [Focus Releases](https://github.com/AIALRA-0/BiliPai_Focus/releases) · [Focus Release Notes](docs/releases/focus-7.1.4-focus.4-en.md) · [Changelog](CHANGELOG.md) · [Focus Changelog](FOCUS_CHANGLOG.md) |
...
| Focus edition | You want the upstream base with quieter defaults, follow filtering, and Focus-specific switches | [Repository](https://github.com/AIALRA-0/BiliPai_Focus) · [Releases](https://github.com/AIALRA-0/BiliPai_Focus/releases) · [Release Notes](docs/releases/focus-7.1.4-focus.4-en.md) · [Focus Changelog](FOCUS_CHANGLOG.md) |

### Current Focus release

| Item | Value |
| --- | --- |
| Focus version | `7.1.4-focus.4` |
| Upstream base | `7.1.4` |
| Release tag | `v7.1.4-focus.4` |
| Release notes | [docs/releases/focus-7.1.4-focus.4-en.md](docs/releases/focus-7.1.4-focus.4-en.md) |
| Main refinements | FOLLOW refresh now commits only after the pull animation fully settles, the first screen is hard-limited to `16` items, and Home FOLLOW adds five ordering modes |
| Public APK | `BliPai-Focus-release-7.1.4-focus.4.apk` |
...
| Added | `docs/releases/focus-7.1.4-focus.4.md` | Chinese release notes for `v7.1.4-focus.4` |
| Added | `docs/releases/focus-7.1.4-focus.4-en.md` | English release notes for `v7.1.4-focus.4` |
...
### Latest (v7.1.4 / v7.1.4-focus.4 · 2026-03-24)

- 🔄 **FOLLOW refresh no longer swaps content early**: manual refresh waits until the pull indicator and content bounce fully settle before committing the new list.
- 📦 **The first screen is now hard-limited to one `16`-item batch**: opening or recalculating FOLLOW no longer dumps dozens of cards onto the page.
- 🧭 **Home FOLLOW now has ordering modes**: the follow-group sheet can switch between `Random`, `Creator cluster desc`, `Creator cluster asc`, `Publish time desc`, and `Publish time asc`.
