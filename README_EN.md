...
<p align="center">
  <sub>Last updated: 2026-03-24 · Upstream base v7.1.4 · Current Focus release v7.1.4-focus.3</sub>
</p>
...
| Category | Entry |
| --- | --- |
| Get Started | [Official Releases](https://github.com/jay3-yy/BiliPai/releases) · [Focus Releases](https://github.com/AIALRA-0/BiliPai_Focus/releases) · [Focus Release Notes](docs/releases/focus-7.1.4-focus.3-en.md) · [Changelog](CHANGELOG.md) · [Focus Changelog](FOCUS_CHANGLOG.md) |
...
| Focus edition | You want the upstream base with quieter defaults, follow filtering, and Focus-specific switches | [Repository](https://github.com/AIALRA-0/BiliPai_Focus) · [Releases](https://github.com/AIALRA-0/BiliPai_Focus/releases) · [Release Notes](docs/releases/focus-7.1.4-focus.3-en.md) · [Focus Changelog](FOCUS_CHANGLOG.md) |

### Current Focus release

| Item | Value |
| --- | --- |
| Focus version | `7.1.4-focus.3` |
| Upstream base | `7.1.4` |
| Release tag | `v7.1.4-focus.3` |
| Release notes | [docs/releases/focus-7.1.4-focus.3-en.md](docs/releases/focus-7.1.4-focus.3-en.md) |
| Main refinements | Fixes the release-only crash when opening any video; the root cause was a `VerifyError` in `VideoDetailScreen` after R8 optimization, so this release keeps shrinking/obfuscation but disables bytecode optimization |
| Public APK | `BliPai-Focus-release-7.1.4-focus.3.apk` |
...
| Added | `docs/releases/focus-7.1.4-focus.3.md` | Chinese release notes for `v7.1.4-focus.3` |
| Added | `docs/releases/focus-7.1.4-focus.3-en.md` | English release notes for `v7.1.4-focus.3` |
...
### Latest (v7.1.4 / v7.1.4-focus.3 · 2026-03-24)

- 🚨 **Fixes the video-open crash**: `focus.2` could throw a release-only `VerifyError` when entering `VideoDetailScreen`, causing every video tap to crash the app.
- 🛠️ **Keeps shrinking, disables bytecode optimization**: this release still ships as a normal release APK, but turns off R8 bytecode optimization for better stability with large Compose video screens.
- 📱 **Verified on a connected device over adb**: the fixed release APK was installed on the attached phone and successfully opened a Bilibili video link without crashing.
