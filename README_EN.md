...
<p align="center">
  <sub>Last updated: 2026-03-24 · Upstream base v7.1.4 · Current Focus release v7.1.4-focus.7</sub>
</p>

<p align="center">
  <img src="https://img.shields.io/badge/Focus-7.1.4--focus.7-fb7299?style=flat-square" alt="Focus Version">
...
| Category | Entry |
| --- | --- |
| Get Started | [Official Releases](https://github.com/jay3-yy/BiliPai/releases) · [Focus Releases](https://github.com/AIALRA-0/BiliPai_Focus/releases) · [Focus Release Notes](docs/releases/focus-7.1.4-focus.7-en.md) · [Changelog](CHANGELOG.md) · [Focus Changelog](FOCUS_CHANGLOG.md) |
...
| Focus edition | You want the upstream base with quieter defaults, follow filtering, and Focus-specific switches | [Repository](https://github.com/AIALRA-0/BiliPai_Focus) · [Releases](https://github.com/AIALRA-0/BiliPai_Focus/releases) · [Release Notes](docs/releases/focus-7.1.4-focus.7-en.md) · [Focus Changelog](FOCUS_CHANGLOG.md) |

### Current Focus release

| Item | Value |
| --- | --- |
| Focus version | `7.1.4-focus.7` |
| Upstream base | `7.1.4` |
| Release tag | `v7.1.4-focus.7` |
| Release notes | [docs/releases/focus-7.1.4-focus.7-en.md](docs/releases/focus-7.1.4-focus.7-en.md) |
| Main refinements | `Random` is fully random again, the default Home FOLLOW order is now `Publish time desc`, and creator/time modes still run on the real dynamic publish timestamp |
| Public APK | `BliPai-Focus-release-7.1.4-focus.7.apk` |
...
| Added | `docs/releases/focus-7.1.4-focus.7.md` | Chinese release notes for `v7.1.4-focus.7` |
| Added | `docs/releases/focus-7.1.4-focus.7-en.md` | English release notes for `v7.1.4-focus.7` |
...
### Latest (v7.1.4 / v7.1.4-focus.7 · 2026-03-24)

- 🔀 **Random is fully random again**: Home FOLLOW now randomizes the whole visible pool again instead of behaving like a lightly perturbed publish-time sort.
- ⬇️ **Default Home FOLLOW order is now `Publish time desc`**: new and unset configs now default to newest-first.
- ✅ **Creator/time ordering still uses the real timestamp**: the `focus.6` publish-time mapping fix remains in place for asc/desc creator/time modes.
