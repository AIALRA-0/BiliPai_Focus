...
import com.android.purebilibili.core.store.home.HomeTopTabSettingsStore
...
object SettingsManager {
    ...
    object TopTabLabelMode {
        const val ICON_AND_TEXT = 0
        const val ICON_ONLY = 1
        const val TEXT_ONLY = DEFAULT_TOP_TAB_LABEL_MODE
    }

    /** 首页顶部 dock 标签数量上限。 */
    const val MAX_TOP_TABS = MAX_HOME_TOP_TABS
    ...
    internal fun mapHomeTopTabSettingsFromPreferences(preferences: Preferences): HomeTopTabSettings =
        HomeTopTabSettingsStore.mapFromPreferences(preferences)

    fun getHomeTopTabSettings(context: Context): Flow<HomeTopTabSettings> =
        HomeTopTabSettingsStore.observe(context)

    internal fun mapFocusSettingsFromPreferences(preferences: Preferences): FocusSettings =
        FocusSettingsStore.mapFromPreferences(preferences)

    fun getFocusSettings(context: Context): Flow<FocusSettings> = FocusSettingsStore.observe(context)
    ...
    fun getSearchHotSectionEnabled(context: Context): Flow<Boolean> = FocusSettingsStore.getSearchHotSectionEnabled(context)
    suspend fun setSearchHotSectionEnabled(context: Context, value: Boolean) = FocusSettingsStore.setSearchHotSectionEnabled(context, value)
    fun getFocusHomeRecommendTabVisible(context: Context): Flow<Boolean> = FocusSettingsStore.getHomeRecommendTabVisible(context)
    suspend fun setFocusHomeRecommendTabVisible(context: Context, value: Boolean) = FocusSettingsStore.setHomeRecommendTabVisible(context, value)
    fun getFocusHomeFollowTabVisible(context: Context): Flow<Boolean> = FocusSettingsStore.getHomeFollowTabVisible(context)
    suspend fun setFocusHomeFollowTabVisible(context: Context, value: Boolean) = FocusSettingsStore.setHomeFollowTabVisible(context, value)
    fun getFocusHomePopularTabVisible(context: Context): Flow<Boolean> = FocusSettingsStore.getHomePopularTabVisible(context)
    suspend fun setFocusHomePopularTabVisible(context: Context, value: Boolean) = FocusSettingsStore.setHomePopularTabVisible(context, value)
    fun getFocusHomeLiveTabVisible(context: Context): Flow<Boolean> = FocusSettingsStore.getHomeLiveTabVisible(context)
    suspend fun setFocusHomeLiveTabVisible(context: Context, value: Boolean) = FocusSettingsStore.setHomeLiveTabVisible(context, value)
    fun getFocusHomeAnimeTabVisible(context: Context): Flow<Boolean> = FocusSettingsStore.getHomeAnimeTabVisible(context)
    suspend fun setFocusHomeAnimeTabVisible(context: Context, value: Boolean) = FocusSettingsStore.setHomeAnimeTabVisible(context, value)
    fun getFocusHomeGameTabVisible(context: Context): Flow<Boolean> = FocusSettingsStore.getHomeGameTabVisible(context)
    suspend fun setFocusHomeGameTabVisible(context: Context, value: Boolean) = FocusSettingsStore.setHomeGameTabVisible(context, value)
    fun getFocusHomeKnowledgeTabVisible(context: Context): Flow<Boolean> = FocusSettingsStore.getHomeKnowledgeTabVisible(context)
    suspend fun setFocusHomeKnowledgeTabVisible(context: Context, value: Boolean) = FocusSettingsStore.setHomeKnowledgeTabVisible(context, value)
    fun getFocusHomeTechTabVisible(context: Context): Flow<Boolean> = FocusSettingsStore.getHomeTechTabVisible(context)
    suspend fun setFocusHomeTechTabVisible(context: Context, value: Boolean) = FocusSettingsStore.setHomeTechTabVisible(context, value)
    fun getFocusHomePartitionButtonVisible(context: Context): Flow<Boolean> = FocusSettingsStore.getHomePartitionButtonVisible(context)
    suspend fun setFocusHomePartitionButtonVisible(context: Context, value: Boolean) = FocusSettingsStore.setHomePartitionButtonVisible(context, value)
    fun getFocusFollowGroupFilteringEnabled(context: Context): Flow<Boolean> = FocusSettingsStore.getFollowGroupFilteringEnabled(context)
    suspend fun setFocusFollowGroupFilteringEnabled(context: Context, value: Boolean) = FocusSettingsStore.setFollowGroupFilteringEnabled(context, value)
    fun getFocusVideoRelatedVideosSectionVisible(context: Context): Flow<Boolean> = FocusSettingsStore.getVideoRelatedVideosSectionVisible(context)
    suspend fun setFocusVideoRelatedVideosSectionVisible(context: Context, value: Boolean) = FocusSettingsStore.setVideoRelatedVideosSectionVisible(context, value)
    fun getFocusHistoryClearAllActionEnabled(context: Context): Flow<Boolean> = FocusSettingsStore.getHistoryClearAllActionEnabled(context)
    suspend fun setFocusHistoryClearAllActionEnabled(context: Context, value: Boolean) = FocusSettingsStore.setHistoryClearAllActionEnabled(context, value)
    fun getSearchDiscoverSectionEnabled(context: Context): Flow<Boolean> = FocusSettingsStore.getSearchDiscoverSectionEnabled(context)
    suspend fun setSearchDiscoverSectionEnabled(context: Context, value: Boolean) = FocusSettingsStore.setSearchDiscoverSectionEnabled(context, value)
    fun getSearchHistorySectionEnabled(context: Context): Flow<Boolean> = FocusSettingsStore.getSearchHistorySectionEnabled(context)
    suspend fun setSearchHistorySectionEnabled(context: Context, value: Boolean) = FocusSettingsStore.setSearchHistorySectionEnabled(context, value)
    //  [新增] --- 底栏显示模式 (0=图标+文字, 1=仅图标, 2=仅文字) ---
    ...
    fun getTopTabLabelMode(context: Context): Flow<Int> = HomeTopTabSettingsStore.getTopTabLabelMode(context)
    suspend fun setTopTabLabelMode(context: Context, value: Int) = HomeTopTabSettingsStore.setTopTabLabelMode(context, value)
    fun getHideTopTabs(context: Context): Flow<Boolean> = HomeTopTabSettingsStore.getHideTopTabs(context)
    suspend fun setHideTopTabs(context: Context, hide: Boolean) = HomeTopTabSettingsStore.setHideTopTabs(context, hide)
    fun getHomeTopRightAction(context: Context): Flow<HomeTopRightAction> = HomeTopTabSettingsStore.getHomeTopRightAction(context)
    suspend fun setHomeTopRightAction(context: Context, action: HomeTopRightAction) = HomeTopTabSettingsStore.setHomeTopRightAction(context, action)
    fun getHomeTopLayoutOrder(context: Context): Flow<HomeTopLayoutOrder> = HomeTopTabSettingsStore.getHomeTopLayoutOrder(context)
    suspend fun setHomeTopLayoutOrder(context: Context, order: HomeTopLayoutOrder) = HomeTopTabSettingsStore.setHomeTopLayoutOrder(context, order)
    fun getTopTabOrder(context: Context): Flow<List<String>> = HomeTopTabSettingsStore.getTopTabOrder(context)
    suspend fun setTopTabOrder(context: Context, order: List<String>) = HomeTopTabSettingsStore.setTopTabOrder(context, order)
    fun getTopTabVisibleTabs(context: Context): Flow<Set<String>> = HomeTopTabSettingsStore.getTopTabVisibleTabs(context)
    suspend fun setTopTabVisibleTabs(context: Context, tabs: Set<String>) = HomeTopTabSettingsStore.setTopTabVisibleTabs(context, tabs)
    ...
    private val shareableSettingDefinitions: List<ShareablePreferenceDefinition> by lazy {
        listOf(
            ...
            BooleanShareablePreferenceDefinition(
                KEY_FOCUS_VIDEO_RELATED_VIDEOS_SECTION_VISIBLE,
            ...
            IntShareablePreferenceDefinition(KEY_DYNAMIC_DETAIL_IMAGE_LAYOUT, SettingsShareSection.NAVIGATION),
