...
internal object StyleLintAllowlist {
    ...
    val SHAPE_HITS: Set<String> = setOf(
        ...
        "src/main/java/com/android/purebilibili/feature/dynamic/components/FocusFollowGroupSheet.kt",
    ...
    val SURFACE_HITS: Set<String> = setOf(
        ...
        "src/main/java/com/android/purebilibili/feature/settings/screen/AppearanceSettingsScreen.kt",
        "src/main/java/com/android/purebilibili/feature/settings/screen/BottomBarSettingsScreen.kt",
        "src/main/java/com/android/purebilibili/feature/settings/screen/FocusSettingsScreen.kt",
        "src/main/java/com/android/purebilibili/feature/settings/screen/IconSettingsScreen.kt",
        "src/main/java/com/android/purebilibili/feature/settings/screen/PluginsScreen.kt",
        "src/main/java/com/android/purebilibili/feature/settings/ui/CacheClearAnimation.kt",
        "src/main/java/com/android/purebilibili/feature/space/SpaceScreen.kt",
