...
- 2026-09-23 17:03 UTC 再次 `git fetch upstream main`：主线前进至 `25f0f4b54548a5a7b915a28725c37518e8ee4798`，`0.2.3-alpha.1`，`versionCode 386`，较当前已合入基点新增 24 提交、54 个改动文件。此批尚未合入；最终 Focus 版本码须高于 386，并在合入后重跑验收。
...
| 0.2.3 alpha.1 新增 24 提交 | 视频标签尺寸、动态详情图片布局、订阅阅读和瀑布流、交互刷新率、首页过滤首次初始化修复、视频共享转场回退 | 正在审计，尚未合入；保留 Focus 过滤/分组及升级链路是融合前提 |
